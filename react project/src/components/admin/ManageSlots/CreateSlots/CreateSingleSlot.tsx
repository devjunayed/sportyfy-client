...
import { Input, Button, DatePicker, TimePicker, Select } from 'antd';
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div style={{ marginBottom: '1rem' }}>
        ...
        <Controller
          ...
          control={control}
          render={({ field }) => (
            <Select {...field} loading={facilitiesLoading} placeholder="Select a facility">
      ...
      <div style={{ marginBottom: '1rem' }}>
        ...
        <Controller
          name="startTime"
          control={control}
          render={({ field }) => <TimePicker {...field} style={{ width: '100%' }} format="HH:mm" />}
        />
      </div>
      <div style={{ marginBottom: '1rem' }}>
