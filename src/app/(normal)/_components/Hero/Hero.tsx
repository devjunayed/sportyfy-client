...
const Hero = () => {
  return (
    <Card className="col-span-12 rounded-none -mt-16   sm:col-span-4 min-h-[60vh] max-h-[90vh] md:max-h-[80vh]">
      <CardHeader className="absolute z-10 mt-8 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 flex-col ">
        ...
        <Button href="/facilities" as="a" variant="ghost" className="mt-2 md:mt-4 dark">Explore <MdExplore /></Button>
      </CardHeader>
      <Image
        removeWrapper
        alt="Card background"
